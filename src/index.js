...
var base = Rebase.createClass({
     // replace with your Firebase application's API key
  apiKey: "AIzaSyAIOEsEiVrAVNYXwu3gH30ILcfrskLcE1A",
  databaseURL: "https://final-81b87.firebaseio.com", // replace with your Firebase application's database URL
})
...
var App = React.createClass({
  ...
  viewChanged: function(view) {
    ...
    if(view==='alpha'){
      movieData = movieData.sort(this.movieCompareByTitle)
    }
    else if (view==='latest') {
      movieData = movieData.sort(this.movieCompareByReleased)
    }
